            ...
            <div class="col-lg-12">
                <div class="brand-carousel-active owl-carousel arrow-style-1">
                    ...
                    <div class="single-brand-wrapper">
                        <a href="#"><img src="{{asset('frontend')}}/images/brand/1.png" alt="Brand Logo"></a>
                    </div>
                    <!-- single-brand-wrapper -->
                    <div class="single-brand-wrapper">
                        <a href="#"><img src="{{asset('frontend')}}/images/brand/2.png" alt="Brand Logo"></a>
                    </div>
                    <!-- single-brand-wrapper -->
                    <div class="single-brand-wrapper">
                        <a href="#"><img src="{{asset('frontend')}}/images/brand/3.png" alt="Brand Logo"></a>
                    </div>
                    <!-- single-brand-wrapper -->
                    <div class="single-brand-wrapper">
                        <a href="#"><img src="{{asset('frontend')}}/images/brand/4.png" alt="Brand Logo"></a>
                    </div>
                    <!-- single-brand-wrapper -->
                    <div class="single-brand-wrapper">
                        <a href="#"><img src="{{asset('frontend')}}/images/brand/5.png" alt="Brand Logo"></a>
                    </div>
                    <!-- single-brand-wrapper -->
                    <div class="single-brand-wrapper">
                        <a href="#"><img src="{{asset('frontend')}}/images/brand/1.png" alt="Brand Logo"></a>
        ...
        <div class="row">
            <div class="col-lg-2">
                ...
                <div class="single-banner-call-to-action-wrapper">
                    <img src="{{asset('frontend')}}/images/icons/arrow-left-2.png" alt="Arrow Image">
                </div>
            </div>
            <div class="col-lg-8">
                <!-- single-banner-call-to-action-wrapper -->
                <div class="single-banner-call-to-action-wrapper">
                    <img src="{{asset('frontend')}}/images/banner/4.png" alt="Image of Banner">
                </div>
            </div>
            <div class="col-lg-2">
                <!-- single-banner-call-to-action-wrapper -->
                <div class="single-banner-call-to-action-wrapper">
                    <img src="{{asset('frontend')}}/images/icons/arrow-right-2.png" alt="Arrow Image">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-12">
                    <div class="footer-logo">
                        <img src="{{asset('frontend')}}/images/logo/footer-logo.png" alt="Nikado Footer Logo">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="payment-accept">
                        <ul>
                            <li><a href="#" title="PayPal"><img src="{{asset('frontend')}}/images/icons/1.png" alt="Payment"></a></li>
                            <li><a href="#" title="Discover"><img src="{{asset('frontend')}}/images/icons/2.png" alt="Payment"></a></li>
                            <li><a href="#" title="Visa"><img src="{{asset('frontend')}}/images/icons/3.png" alt="Payment"></a></li>
                            <li><a href="#" title="PayPal"><img src="{{asset('frontend')}}/images/icons/4.png" alt="Payment"></a></li>
                            <li><a href="#" title="MasterCard"><img src="{{asset('frontend')}}/images/icons/5.png" alt="Payment"></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="product-details-tab-1 mb-80">
                                        <div class="tab-content product-details-large">
                                            <div class="tab-pane active" id="product-details-tab-1-1" >
                                                <div class="easyzoom easyzoom--overlay">
                                                    <a href="{{asset('frontend')}}/images/product/1.jpg"><img src="{{asset('frontend')}}/images/product/1.jpg" alt="Images of Product"></a>
                                                </div>
                                            </div>
                                            <div class="tab-pane" id="product-details-tab-1-2" >
                                                <div class="easyzoom easyzoom--overlay">
                                                    <a href="{{asset('frontend')}}/images/product/2.jpg"><img src="{{asset('frontend')}}/images/product/2.jpg" alt="Images of Product"></a>
                                                </div>
                                            </div>
                                            <div class="tab-pane" id="product-details-tab-1-3" >
                                                <div class="easyzoom easyzoom--overlay">
                                                    <a href="{{asset('frontend')}}/images/product/3.jpg"><img src="{{asset('frontend')}}/images/product/3.jpg" alt="Images of Product"></a>
                                                </div>
                                            </div>
                                            <div class="tab-pane" id="product-details-tab-1-4" >
                                                <div class="easyzoom easyzoom--overlay">
                                                    <a href="{{asset('frontend')}}/images/product/4.jpg"><img src="{{asset('frontend')}}/images/product/4.jpg" alt="Images of Product"></a>
                                                </div>
                                            </div>
                                            <div class="tab-pane" id="product-details-tab-1-5" >
                                                <div class="easyzoom easyzoom--overlay">
                                                    <a href="{{asset('frontend')}}/images/product/5.jpg"><img src="{{asset('frontend')}}/images/product/5.jpg" alt="Images of Product"></a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="nav product-details-small modal-tab-carousel-active owl-carousel arrow-style-3">
                                            <a class="active" href="#product-details-tab-1-1">
                                                <img src="{{asset('frontend')}}/images/product/1.jpg" alt="Images of Product">
                                            </a>
                                            <a href="#product-details-tab-1-2">
                                                <img src="{{asset('frontend')}}/images/product/2.jpg" alt="Images of Product">
                                            </a>
                                            <a href="#product-details-tab-1-3">
                                                <img src="{{asset('frontend')}}/images/product/3.jpg" alt="Images of Product">
                                            </a>
                                            <a href="#product-details-tab-1-4">
                                                <img src="{{asset('frontend')}}/images/product/4.jpg" alt="Images of Product">
                                            </a>
                                            <a href="#product-details-tab-1-5">
                                                <img src="{{asset('frontend')}}/images/product/5.jpg" alt="Images of Product">
                                            </a>
                                        </div>
                                    </div>
                                </div>
...
<!-- Mirrored from d29u17ylf1ylz9.cloudfront.net/nikado-v1/nikado/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Aug 2018 00:41:42 GMT -->
</html>
